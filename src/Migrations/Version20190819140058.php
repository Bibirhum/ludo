 ...
 */
final class Version20190819140058 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD category VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP category_id');
    }
}
